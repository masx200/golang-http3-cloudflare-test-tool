...
func GetQueryCallbacks2() generic.MapInterface[string, func(m *dns.Msg) (r *dns.Msg, err error)] {
	return generic.MapImplementFromMap(map[string]func(m *dns.Msg) (r *dns.Msg, err error){"https://ykxkqhbc8x.apuk83ea3z.de5.net/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/one.one.one.one/dns-query": func(m *dns.Msg) (r *dns.Msg, err error) {
...
func TestResolver77(t *testing.T) {
	...
	results, err := dns_experiment.DnsResolverMultipleServers(x, generic.MapImplementFromMap(map[string]func(m *dns.Msg) (r *dns.Msg, err error){"https://ykxkqhbc8x.apuk83ea3z.de5.net/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/one.one.one.one/dns-query": func(m *dns.Msg) (r *dns.Msg, err error) {
		return DohClient(m, "https://ykxkqhbc8x.apuk83ea3z.de5.net/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/one.one.one.one/dns-query")
...
func TestResolver4(t *testing.T) {
	...
	results, err := dns_experiment.DnsResolverMultipleServers(x,
		generic.MapImplementFromMap(map[string]func(m *dns.Msg) (r *dns.Msg, err error){"https://ykxkqhbc8x.apuk83ea3z.de5.net/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/one.one.one.one/dns-query": func(m *dns.Msg) (r *dns.Msg, err error) {
			return DohClient(m, "https://ykxkqhbc8x.apuk83ea3z.de5.net/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/one.one.one.one/dns-query")
		}, "https://dns.alidns.com/dns-query": func(m *dns.Msg) (r *dns.Msg, err error) {
			return DohClient(m, "https://dns.alidns.com/dns-query")
		}}), func(dro *dns_experiment.DnsResolverOptions) {
